...
const Page = () => {
  return (
    <div >
        ...
        <div className="flex md:flex-row  flex-col xl:px-20 ">
         ...
         <form action="" className="md:w-1/2 md:space-y-3 space-y-1  mt-14 lg:px-12 flex flex-col gap-3">
          ...
          <label htmlFor="name" className="flex flex-col gap-2 md:gap-3">
            ...
            <input type="text" name="name" id="name" placeholder="Isha Khan" className="md:px-4 px-2 py-2 md:py-5 rounded-xl border outline-none border-[#9F9F9F] " />
          </label>
         
          <label htmlFor="email" className="flex flex-col gap-2 md:gap-3">
            <p className="text-[16px] font-medium">Email Address</p>
            <input type="text" name="email" id="email" placeholder="isha92849@gmal.com" className="md:px-4 px-2 py-2 md:py-5 rounded-xl border outline-none border-[#9F9F9F] " />
          </label>
        ...
        <div className="lg:mx-20 sm:mx-10 mx-3 mt-10 bg-[#F4F4F4] flex sm:flex-row flex-col items-center px-5 sm:gap-0 gap-5 text-[#242424] py-10 lg:py-20 sm:justify-around">
          {Promotion.map((card)=>{
            return(
